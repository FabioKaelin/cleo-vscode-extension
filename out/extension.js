...
exports.jsonToHTML = exports.deactivate = exports.activate = void 0;
...
function activate(context) {
    ...
    let disposable = vscode.commands.registerCommand('extension.viewJson', () => {
        ...
        if (currentPanel) {
            ...
            currentPanel = vscode.window.createWebviewPanel('cleopannel', // Identifies the type of the webview. Used internally
            "Cleo Json", // Title of the panel displayed to the user
...
function jsonToHTML(json, uri, rootPath, webView) {
...
function toHTML(content, title, extPath, webView) {
